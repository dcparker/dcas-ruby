...
angola = DCAS.new(:username => 'angola', :password => '4ng014', :cache_location => './EFT')

# You can generate a payments file from a collection of DCAS::Payment objects
DCAS.generate!(filename, data)

# Upload any file to the payments folder of a DCAS bucket
angola.submit_file!(filename)
...
DCAS.each_response_in(response_filename) { ... }
DCAS.each_response_in(response_file_content) { ... }
